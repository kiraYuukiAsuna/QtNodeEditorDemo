...
/// @ Lightweight class incapsulating paint code.
    class NODE_EDITOR_PUBLIC CustomNodePainter : public AbstractNodePainter {
    public:
        ...
        void drawNodeLeftIcon(QPainter *painter, NodeGraphicsObject &ngo) const;

        void drawNodeRightIcon(QPainter *painter, NodeGraphicsObject &ngo) const;
